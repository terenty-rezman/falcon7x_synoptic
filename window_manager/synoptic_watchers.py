...
@add_to_watchers
class SYNOPTIC_DOWN_1_TilesWatcher(TilesWatcherBase):
    watch_tile_type = WindowTile.SYNOPTIC
    screen_type = ScreenPosition.MDU_DOWN

    qml_component_path = "components/Synoptic_window.qml"
    view_name = "synoptic_down_1"
    view_title = "SYNOPTIC down 1 - falcon7x"
...
@add_to_watchers
class SYNOPTIC_DOWN_2_TilesWatcher(SYNOPTIC_DOWN_1_TilesWatcher):
    watch_tile_type = WindowTile.SYNOPTIC
    screen_type = ScreenPosition.MDU_DOWN

    qml_component_path = "components/Synoptic_window.qml"
    view_name = "synoptic_down_2"
    view_title = "SYNOPTIC down 2 - falcon7x"
...
@add_to_watchers
class SYNOPTIC_UP_1_TilesWatcher(SYNOPTIC_DOWN_1_TilesWatcher):
    watch_tile_type = WindowTile.SYNOPTIC
    screen_type = ScreenPosition.MDU_UP

    view_name = "synoptic_up_1"
...
@add_to_watchers
class SYNOPTIC_UP_2_TilesWatcher(SYNOPTIC_DOWN_2_TilesWatcher):
    watch_tile_type = WindowTile.SYNOPTIC
    screen_type = ScreenPosition.MDU_UP

    view_name = "synoptic_up_2"
